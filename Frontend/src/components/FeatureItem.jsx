export default function FeatureItem({
  ...
  return (
    <div
      className="flex flex-col group rounded-3xl p-6 md:p-8 bg-white/10 backdrop-blur-2xl border border-white/10
    ...
    >
      ...
      <div className="text-xl md:text-2xl font-bold text-white mb-4 group-hover:text-indigo-300 transition-all duration-300">
        {title}
      </div>
