...
export default function EmptyFavorites() {
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900 px-6 md:px-8 py-12 md:py-16 text-center">
      <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-red-500/10">
        <Heart className="h-10 w-10 fill-red-400 text-red-400" />
      </div>

      <h2 className="mt-6 text-xl md:text-2xl font-bold text-white">
        No favorites yet
      </h2>
