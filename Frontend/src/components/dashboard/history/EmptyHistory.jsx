  ...
  return (
    <div className="flex items-center justify-center rounded-2xl p-10 bg-slate-900 border border-slate-800 min-h-112.5">
      <div className="flex flex-col items-center max-w-md">
        ...
        <h1 className="text-white font-bold text-2xl mt-6">No History Yet</h1>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-6 py-3 text-white font-medium mt-5 hover:bg-indigo-500 hover:shadow-lg hover:shadow-indigo-500/20  transition-all duration-200 cursor-pointer"
        >
          <Sparkles size={18} />
          Generate with AI
        </button>
